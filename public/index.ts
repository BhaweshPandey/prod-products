...
export const Images = {
  ...
  backgroundImage:prefix+"./image/background_image.png",
  mobileImage: prefix+"./image/mobile_img.png",
  commentImage:prefix+"./image/comment_img.png",
  mobileSection: prefix+"./image/mobile_section.png",
  cardOne:prefix+"./image/card_one.png",
  cardTwo:prefix+"./image/card_two.png",
  cardThree:prefix+"./image/card_three.png",
  globeImage:prefix+"./image/globe_Image.png",
  personImage: prefix+"./image/person_image.png",
  carouselImage:prefix+"./image/carousel_img.png",
  startImage:prefix+"./image/start_img.png",
  triangleImage: prefix+"./image/triangle_img.png",
  gradientCircle:prefix+"./image/gradient_circle_img.png",
  blueCircle:prefix+"./image/blue_circle_img.png",
  pinkCircle:prefix+"./image/pink_circle.png"
